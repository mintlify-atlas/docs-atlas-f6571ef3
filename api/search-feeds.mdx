---
title: "POST /feed/search — Search News by Title"
sidebarTitle: "POST /feed/search"
description: "POST /feed/search performs a case-insensitive title substring search on stored news feed items and returns the matching array."
---
