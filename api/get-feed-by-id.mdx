---
title: "GET /feed/:id — Retrieve a Single News Item"
sidebarTitle: "GET /feed/:id"
description: "GET /feed/:id returns a single news feed item from MongoDB by its ObjectId. Returns 404 if the item does not exist."
---
