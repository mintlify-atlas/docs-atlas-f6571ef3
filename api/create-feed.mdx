---
title: "POST /feed — Create a New News Feed Item in MongoDB"
sidebarTitle: "POST /feed"
description: "POST /feed creates a new news feed item in MongoDB. Both title and link are required; omitting either returns a 400 Bad Request with no database write."
---
