---
title: "DailyNews Environment Variable Reference"
...
<ParamField body="VITE_BACKEND_BASE_URI" type="string" required>
  Base URL of the backend feed endpoint. Used by `frontend/src/utils/apiConstants.ts` to construct all API endpoint paths (`getAllFeeds`, `createFeed`, `searchFeedsByTitle`, etc.).
