...
description: "The DailyNews frontend is a React 18 single-page app built with Vite, TypeScript, Tailwind CSS, and React Router v7, featuring real-time search and dark mode."
---
